...
use App\Respositor\UserRepository;
...
class User implements UserInterface, \Serializable
{
     ...
     * Add event
     *
     * @param \App\Entity\Attendance $event
     *
     * @return User
     */
    public function addEvent(\App\Entity\Attendance $event)
    {
        $this->events[] = $event;
        $this->attendance++;
     ...
     * @param \App\Entity\Attendance $event
     */
    public function removeEvent(\App\Entity\Attendance $event)
    {
